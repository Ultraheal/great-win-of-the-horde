...
К сожалению решение с роутером, которое мы сделали по этому гайду не поддерживает AmneziaWG 2.0, позже я доработаю его, и допишу в гайде, но пока в текущей парадигме нужно будет поднять второй контейнер с амнезией, в итоге будет и 1.5 и 2.0. Для роутера мы будем использовать пока что 1.5, а вот для мобильных клиентов сразу перейдем на 2.0 с ним у меня все работает хорошо с мобильного интернета
